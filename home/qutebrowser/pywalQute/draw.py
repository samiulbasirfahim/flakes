...
def color(c, options={}):
    ...
    c.colors.completion.item.selected.bg = colorjson["function"]
    ...
    c.colors.contextmenu.disabled.fg = palette['foreground-alt']
    c.colors.contextmenu.menu.bg = palette['background']
    c.colors.contextmenu.menu.fg = palette['foreground']
    c.colors.contextmenu.selected.fg = colorjson["background"]
    c.colors.contextmenu.selected.bg = colorjson["function"]
